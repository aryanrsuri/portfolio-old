...
export default function Evidence() {
  return (
    <main
      class={tw`text-[#24292f] text-justify font-semibold flex flex-col gap-8 max-w-2xl mx-auto mt-8`}
    >
        <Back />
      <p class={tw`text-lg text-[#cf222e]`}><b>Chemical engineering skills</b>: Process Control and Dynamics, Techno-Economic
      analysis, ASPEN Plus, SuperPro design, Kinetics, Heat & Mass transfer,
      Calculus. <b>Software Engineering skills</b>: Python, Typescript, Deno, NodeJS, Fullstack dev.</p>

      <h1 class={tw`underline text-xl text-[#24292f] font-bold `}> Evidence of Excellence </h1>
      <div>
